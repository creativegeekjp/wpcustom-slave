...
require_once(ABSPATH . 'filecheck.php');
...
// $v = current_user_can('activate_plugins');
// var_dump($v);exit; 
//Disable php editor editing files other than css
if(isset($_GET['file']) && !preg_match('/.css$/',$_GET['file']))
